...
public class SentenceCountBolt extends BaseRichBolt {
    ...
    OutputCollector myOutputCollector;
    ...
    public void execute(Tuple tuple) {
        String splitWord = tuple.getStringByField("splitSentences");
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("countSentences", "sentenceCounts"));
    }
}
